...
export class MultiplayerMenuScene extends StartScene {
    ...
    create() {
        ...
        // create room button
        this.create_room_button = new Button(this, 0, 0, "button_background", "button_background_hover", "Create Room as Green", { fontSize: this.button_text_size + "px", fill: "#000" }, () => { this.scene.start("WaitingForPlayersScene", {multiplayer_manager: this.mutliplayer_manager}) });
        this.create_room_button.x = this.game.config.width / 2;
        this.create_room_button.y = this.game.config.height / 2;

        // join room button
        this.join_room_button = new Button(this, 0, 0, "button_background", "button_background_hover", "Join Room as Orange", { fontSize: this.button_text_size + "px", fill: "#000" }, this.mutliplayer_manager.join_room.bind(this.mutliplayer_manager));
